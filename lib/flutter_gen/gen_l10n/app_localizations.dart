...
abstract class AppLocalizations {
  ...
  /// No description provided for @voicePageTitle.
  ///
  /// In en, this message translates to:
  /// **'Voice Companion'**
  String get voicePageTitle;
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome to Realove AI'**
  String get onboardingTitle;

  /// No description provided for @onboardingSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Your emotionally tuned voice companion'**
  ...
  /// No description provided for @replyCounter.
  ///
  /// In en, this message translates to:
  /// **'Reply {count}'**
  ...
  /// No description provided for @loginWithJWT.
  ///
  /// In en, this message translates to:
  /// **'Login with JWT Token'**
  String get loginWithJWT;
}
